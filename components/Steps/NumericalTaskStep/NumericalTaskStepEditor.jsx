...
const NumericalTaskStepEditor = () => {
  ...
  return (
    <div>
      ...
      />
      <h3 className="editor-lesson-title mt-5 mb-3">Enter the expected answer:</h3>
      <input
        ...
        name="math-answer"
        id="math-answer"/>
      <span className="info-title d-block">*Please note that the answer can be in whole or fractional numbers.</span>
      <Button className="mt-3" type={'submit'} disabled={isLoading}>{isLoading ? 'Saving...' : 'Save'}</Button>
    </div>
  )
}

export default NumericalTaskStepEditor
